        ...
        <div class="content">
            ...
            <div class="widgets">
                <div class="widget">
                    <h5>Students</h5>
                    <p>8,000</p>
                    <p>See all <span><a href="students.php">Students</a></span></p>
                </div>
                <div class="widget">
                    <h5>Courses</h5>
                    <p>800</p>
                    <p>See all <span><a href="courses.php">courses</a></span></p>
                </div>
                <div class="widget">
                    <h5>Lecturers</h5>
                    <p>600</p>
                    <p>See all <span><a href="lecturers.php">Lectures</a></span></p>
                </div>
                <div class="widget">
                    <h5>Admins</h5>
                    <p>15</p>
                    <p>See all <span><a href="admins.php">Admins</a></span></p>
                </div>
            </div>
            <div class="courses">
                ...
                <div class="students">
                    <?php
                        ...
                        echo "<table>";
                        echo "<tr><th>ID</th><th> Course Name</th><th> Course Id</th><th>Unit Code</th><th> School</th><th>Actions</th></tr>";
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><form method='post' action='edit_course.php'><input type='hidden' name='id' value='".$row['id']."'><input type='submit' value='Edit'></form></td>";
                            echo "</tr>";
                        }
                        echo "</table>";
