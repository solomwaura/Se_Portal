        ...
        <div class="content">
            ...
            <div class="students">
                ...
                <?php
                    ...
                    echo "<table>";
                    echo "<tr><th>ID</th><th> First Name</th><th> Last Name</th><th>Email</th><th> Phone</th><th>Lecturer Number</th><th>Actions</th></tr>";
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><form method='post' action='lec_edit.php'><input type='hidden' name='id' value='".$row['id']."'><input type='submit' value='Edit'></form></td>";
                        echo "</tr>";
                    }
                    echo "</table>";
